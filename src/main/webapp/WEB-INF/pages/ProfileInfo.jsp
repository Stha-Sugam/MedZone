...
<link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/images/user.png">
	...
	<main>
		...
		<div class = "profile-container">
			<div class = "left-container">
				<ul class = "side-menu">
					<li><a class = "menu-item" data-target="info-section">Your Information</a></li>
					<li><a class = "menu-item" data-target="edit-profile">Edit your profile</a></li>
					<li><a class = "menu-item" data-target="update-password">Change your password</a></li>
				</ul>
			</div>
					...
					<form class = "form" id = "UpdatePassword" action = "UpdatePassword" method = "post">
						...
						<div class = "single-section">
							<div class = "inner-section">
								...
								<div class = "${empty oldPassError ? 'normal-input' : 'error-input'}">
									<i class="fa fa-lock"></i>
									<input type = "password" id = "oldPassword" name = "oldPassword" value = "${param['oldPassword']}" placeholder = "Enter your old password">
								</div>
								<p class = "field-error">
									<c:choose>
						...
						<div class = "single-section">
							<div class = "inner-section">
								...
								<div class = "${empty newPassError? 'normal-input' : 'error-input'}">
									<i class="fa fa-lock"></i>
									<input type = "password" id = "newPassword" name = "newPassword" value = "${param['newPassword']}" placeholder = "Enter a new password">
								</div>
								<p class = "field-error">
									<c:choose>
						...
						<div class = "single-section">
							<div class = "inner-section">
								...
								<div class = "${empty cpassError? 'normal-input' : 'error-input'}">
									<i class="fa fa-lock"></i>
									<input type = "password" id = "cpassword" name = "cpassword" value = "${param['cpassword']}" placeholder = "Confirm your new password">
								</div>
								<p class = "field-error">
									<c:choose>
						...
						<div class = "single-section">
							<div class = "inner-section">
								...
								<div class = ${empty firstNameError ? 'normal-input' : 'error-input'}>
									...
									<input type = "text" id = "first-name" name = "first-name" value = "${user.firstName}" placeholder = "Enter your first name">
								</div>
								<p class = "field-error">
									<c:choose>
						...
						<div class = "single-section">
							<div class = "inner-section">
								...
								<div class = "${empty lastNameError? 'normal-input' : 'error-input'}">
									<i class="fa fa-user"></i>
									<input type = "text" id = "last-name" name = "last-name" value = "${user.lastName}" placeholder = "Enter your last name">
								</div>
								<p class = "field-error">
									<c:choose>
						...
						<div class = "single-section">
							<div class = "inner-section">
								...
								<div class = "${empty phoneNumError ? 'normal-input' : 'error-input'}">
									...
									<input type = "text" id = "phone-num" name = "phone-num" value = "${user.phone}" placeholder = "Enter your phone number">
								</div>
								<p class = "field-error">
									<c:choose>
